...
const notificationMapping: Record<string, NotificationConfigInterface> = {
  'Product Addition.create': {
    roles: ['business-owner', 'supply-chain-analyst', 'sales-representative'],
    key: 'product_addition',
    tenantPath: [],
    userPath: [],
  },
  'Supply Chain Issue.update': {
    roles: ['business-owner', 'inventory-manager', 'sales-representative'],
    key: 'supply_chain_issue',
    tenantPath: [],
    userPath: [],
  },
  'New Sale.create': {
    roles: ['business-owner', 'inventory-manager', 'supply-chain-analyst'],
    key: 'new_sale',
    tenantPath: [],
    userPath: [],
  },
