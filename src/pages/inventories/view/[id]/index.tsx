            ...
            <FormWrapper wrapperProps={{ border: 'none', gap: 3, p: 0 }}>
              ...
              >
                ...
                <FormListItem
                  ...
                  text={
                    data?.last_restock_date
                      ? format(parseISO(data?.last_restock_date as unknown as string), 'dd-MM-yyyy')
                      : ''
                  }
                />
                ...
                <FormListItem
                  ...
                  text={
                    data?.next_restock_date
                      ? format(parseISO(data?.next_restock_date as unknown as string), 'dd-MM-yyyy')
                      : ''
                  }
                />
